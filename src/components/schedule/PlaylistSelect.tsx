                    ...
                    <SelectItem key={playlist._id} value={playlist._id}>
                      <div className="flex items-center gap-3">
                        {playlist.artwork ? (
                          ...
                          <div className="flex h-10 w-10 items-center justify-center rounded-sm bg-muted flex-shrink-0">
                            <Music2 className="h-5 w-5 text-muted-foreground" />
                          </div>
                        )}
                        <div className="flex flex-col gap-0.5 min-w-0 pl-0">
                          <p className="text-sm font-medium leading-none truncate">{playlist.name}</p>
