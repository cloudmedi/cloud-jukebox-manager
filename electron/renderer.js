...
ipcRenderer.on('playlist-deleted', (event, { playlistId, message }) => {
...
ipcRenderer.on('stop-playlist', (playlistId) => {
  ...
  if (currentPlaylist && currentPlaylist._id === playlistId) {
    ...
    console.log('Stopped deleted playlist:', playlistId);
  }
});
